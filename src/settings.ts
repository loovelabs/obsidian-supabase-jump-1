...
/**
 * Check if a vault_files row was generated by the LOOVE translation layer.
 * System notes have a `source_table` field in their frontmatter.
 */
export function isSystemGeneratedNote(
	frontmatter: Record<string, unknown> | null | undefined,
): boolean {
	if (!frontmatter) return false;
	return typeof frontmatter.source_table === "string" && frontmatter.source_table.length > 0;
}
...
export class SupaBaseJumpSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Creates the table, enables realtime, and creates the attachments storage bucket. Run once after creating your supabase project.",
			)
			.addButton((btn) => {
		...
		new Setting(containerEl)
			...
			.setDesc(
				"ID of the system-generated vault (LOOVE translation layer notes). Leave as default unless you know what you're doing.",
			)
			.addText((text) =>
				text
