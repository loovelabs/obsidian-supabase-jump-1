...
--
-- Run in Supabase SQL Editor AFTER the vault_files table has been created
-- by the plugin's One-Click Setup.
-- ============================================================================
...
-- Uncomment and execute after triggers are in place.
-- ============================================================================
